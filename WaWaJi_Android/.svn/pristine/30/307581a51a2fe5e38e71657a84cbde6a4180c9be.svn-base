 ...
 */
abstract class ClassLoaderSavedState implements Parcelable {
    private static final ClassLoaderSavedState EMPTY_STATE = new ClassLoaderSavedState() {};
     ...
     */
    ClassLoaderSavedState(Parcelable superState, ClassLoader classLoader) {
     ...
     * @param source
     */
    ClassLoaderSavedState(Parcel source) {
