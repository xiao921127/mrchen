...
//                                " is in column:" + column);
    ...
    @Override
    protected void onLayoutChild(View child,
                                 int position,
                                 boolean flowDown,
                                 int childrenLeft, int childTop,
    ...
    private void layoutGridChild(View child, int position,
                                 boolean flowDown,
                                 int childrenLeft, int childRight) {
...
//        if (DBG) Log.d(TAG, "offset mDistanceToTop:" + mDistanceToTop);
    ...
    private int calculateColumnWidth(int gridWidth) {
        int listPadding = getRowPaddingLeft() + getRowPaddingRight();
...
//                            " heightRatio:" + rec.heightRatio);
    ...
    private int getLowestPositionedBottom() {
        int column = getLowestPositionedBottomColumn();
        return mColumnBottoms[column];
    }
    ...
    private int getLowestPositionedTop() {
        int column = getLowestPositionedTopColumn();
        return mColumnTops[column];
    }
    ...
    private int getHighestPositionedTop() {
        int column = getHighestPositionedTopColumn();
        return mColumnTops[column];
    }
